...
const Button = ({
  ...
  switch (variant) {
    ...
    case 'secondary':
      ...
      break;
    case 'outline':
      baseStyles += ' border border-primary-500 text-primary-500 hover:bg-primary-50 focus:ring-primary-500';
      break;
    case 'ghost':
      baseStyles += ' text-neutral-dark hover:bg-neutral-light-200 dark:text-neutral-light dark:hover:bg-neutral-dark/20 focus:ring-neutral-dark/50';
      break;
    default:
      baseStyles += ' bg-primary-500 text-white hover:bg-primary-600 focus:ring-primary-500';
  }
